...
/// chrome on top.
///
/// YOLOShowcase provides full multi-task (Detect/Segment/Semantic/Classify/Pose/OBB) and multi-size (n/s/m/l/x)
/// support with automatic model downloading from GitHub releases. Download progress is shown on the model size chips.
...
class _CameraInferenceScreenState extends State<CameraInferenceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // YOLOShowcase handles model downloading, size switching (n/s/m/l/x), and download progress automatically.
    return Scaffold(
